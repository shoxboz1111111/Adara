...
<head>
    ...
    <title>Adara online shop orders page</title>
                ...
                <div class="row">
                    <div class="col-12">
                        @foreach ($orders as $order)
                            <div>
                                <div class="alert alert-primary" role="alert" data-toggle="collapse"
                                    data-target="#collapseExample{{ $order->id }}" aria-expanded="false"
                                    aria-controls="collapseExample{{ $order->id }}">
                                    <h3>Order ID: {{ $order->id }}</h3>
                                    <p class="p-0 m-0">Holati: <span
                                            class="badge badge-secondary">{{ $order->status }}</span></p>
                                    <p class="p-0 m-0">Buyurtma Sanasi: <b>{{ $order->created_at }}</b></p>
                                    <p class="p-0 m-0">Topshirish punkti: <b>{{ $order->country }} ,
                                            {{ $order->state }} </b></p>
                                    <p class="p-0 m-0">Ish vaqti: <b>9:00-19:00 </b></p>
                                    <p class="p-0 m-0">Buyurtma qiymati: <b>{{ $order->total_sum }} sum</b></p>
                                </div>
                                        ...
                                        <div class="card card-body mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="{{ route('main.show', $product->id) }}"> <img
                                                        src="{{ $product->image }}"
                                                        href="/shop/details/{$product->id}" width="130"
                                                        class="pr-3" alt=""></a>
                                                <div>
                                                    <h6> Product ID: {{ $product->product_id }}</h6>
                                                    <p class="p-0 m-0">Nomi: <b>{{ $product->name }}</b></p>
                                                    <p class="p-0 m-0">Soni: <b>{{ $product->count }}</b></p>
                                                    <p class="p-0 m-0">Narxi: <b>{{ $product->price }}</b> sum</p>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
