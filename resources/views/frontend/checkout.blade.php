...
<head>
    ...
    <title>Adara online shop checkout page</title>
                    ...
                    <div class="col-sm-6">
                        <div class="header-top-link">
                            <ul>
                                ...
                                <li><a href="tel:947802707">email:{{ $client != null ?  $client->email : 'not loginedd' }}</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="footer-logo">
                            <a href="{{ route('main.page') }}"><img src="{{ asset($settings->site_logo) }}" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
