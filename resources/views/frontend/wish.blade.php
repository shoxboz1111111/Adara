...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Adara online shop | Wish page</title>
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                           ...
                                           <tr>
                                               ...
                                               <td class="product-thumbnail"><a href="{{ route('main.show' , $wish->product_id) }}"><img src="{{ asset($wish->image) }}" alt=""></a></td>
                                               <td class="product-name">
                                                   <h4>{{ $wish->name }}</a></h4>
                                               </td>
                                               <td class="product-price">

                                                <h6 style="color: red"><del>{{ $wish->price }}</del></h6>
                                                <h6 style="color:green"> {{ ($wish->price - $wish->price * ($wish->discount / 100))  }}
                                                </h6>
                                               ...
                                               <td class="product-delete">
                                                   <a class="mr-2" href="{{route('main.show', $wish->product_id)}}"><i class="fa fa-eye"></i></a>
                                                   <a href="{{ route( 'delete.wish' , $wish->id )}}"><i class="flaticon-trash"></i></a>
                                               </td>
                                           </tr>
                                           @endforeach
                                           @endif
                ...
                <div class="col-12">
                    <div class="footer-logo">
                        <a href="{{ route('main.page') }}"><img
                                src="{{ asset($settings->site_logo) }}" width="150px"
                                alt=""></a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="footer-text">
                            ...
                            <div class="footer-social">
                                <ul>
                                    ...
                                    <li><a href="https://t.me/https://t.me/shoxboz_04_16c2  " target="_blank"><i
