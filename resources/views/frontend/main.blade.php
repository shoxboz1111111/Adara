                                ...
                                <nav class="menu-nav show">
                                    <div class="logo d-block d-lg-none">
                                        <a href="{{ route('main.page') }}" class="main-logo"><img
                                                src="{{ asset('frontend/assets/img/logo/w_logo.png') }}"
                                                alt="Logo"></a>
...
<li>
                                    ...
                                    <div class="navbar-wrap main-menu d-none d-lg-flex">
                                        <ul class="navigation">
                                            ...
                                            @if ($client)
                                                <li><a href="{{ route('order.page') }}">Orders</a></li>
                                            @endif
                                        </ul>
                                    </div>
                            ...
                            <div class="mobile-menu">
                                ...
                                <nav class="menu-box">
                                    <div class="nav-logo"><a href="{{ route('main.page') }}"><img
                                                src="{{ asset('img/logo/logo.png') }}" alt=""
                                                title=""></a>
                                ...
                                @foreach ($category->products->where('type', 'future') as $product)
                                    <div class="col">
                                       ...
                                       <div class="discount-tag">bu productda chegirma mavjud emas</div> --}}
                                            ...
                                            <div class="features-product-cart"><a href="#">add to cart</a></div>
                                        </div>
                    ...
                    @foreach ($ads as $item)
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="https://t.me/https://t.me/shoxboz_04_16" target="_blank">
                        ...
                        <div class="footer-link-wrap">
                            ...
                            <div class="footer-social">
                                <ul>
                                    ...
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href=""><i class="fab fa-youtube"></i></a></li>
                                    <li><a href="https://instagram/https://www.instagram.com/xasanov_shoxboz?igsh=cWU0emJhbDIyam55" target="_blank"><i
